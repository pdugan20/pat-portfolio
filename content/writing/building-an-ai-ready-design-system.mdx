---
title: 'Your next design system might not need Figma at all'
date: '2025-07-03'
...
relatedWriting:
  - title: 'Second Post'
    ...
    date: '2024-01-20'
    imageSrc: '/assets/building-an-ai-ready-design-system/mov/poster/01.jpg'
...
I’ve also built design systems from scratch at Quora, the [Chan Zuckerberg Initiative](https://www.czi.com/), and for smaller-scale zero-to-one efforts like [Hikearound](https://www.tryhikearound.com/). Having said that, it had been a few years since I’d built something like this end-to-end (components, variables, documentation, etc) starting all the way from a blank Figma file.

<PostImage
  images={[
    {
      src: '/assets/building-an-ai-ready-design-system/img/06.png',
      alt: 'Two example chat threads created with the UI kit',
      caption:
        'Example of a 1:1 and group iMessage chat thread created with the iMessage Chat Builder UI kit in Figma, shown in both light and dark themes.',
    },
  ]}
/>
...
## Building outward from primitives
...
<PostImage
  images={[
    {
      src: '/assets/building-an-ai-ready-design-system/img/05.png',
      alt: 'A Figma screenshot showing color primitives',
      caption:
        'Color primitives from the iMessage Chat Builder UI kit variable library being applied as light and dark mode backgrounds to different UI components.',
    },
  ]}
/>
...
<PostImage
  images={[
    {
      src: '/assets/building-an-ai-ready-design-system/img/07.png',
      alt: 'A text bubble Figma component',
      caption:
        'An example sender text bubble component, showing stacked messages, an emoji reaction, and mustache text with delivery status.',
    },
    {
      src: '/assets/building-an-ai-ready-design-system/img/08.png',
      alt: 'A text bubble reply Figma component',
      caption:
        'An example of a reply text bubble component showing a reply to an existing message in a group thread, with mustache text showing the total number of replies.',
    },
    {
      src: '/assets/building-an-ai-ready-design-system/img/09.png',
      alt: 'A text bubble reply Figma component',
      caption:
        'An example of a reply text bubble component showing a reply to an existing message in a group thread, with mustache text showing the total number of replies.',
    },
...
<PostImage
  images={[
    {
      src: '/assets/building-an-ai-ready-design-system/img/11.png',
...
## Show but also tell via documentation
...
<PostMovie
  videos={[
    {
      src: '/assets/building-an-ai-ready-design-system/mov/02.mp4',
      alt: 'Advanced component interaction demonstration',
      caption:
        'An in-depth look at component interactions and variable system implementation, showcasing the modular architecture of the AI-ready design system.',
    },
  ]}
/>
...
<PostImage
  images={[
    {
      src: '/assets/building-an-ai-ready-design-system/img/10.png',
